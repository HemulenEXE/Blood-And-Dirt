...
/// <summary>
/// Класс, реализующий "настройки игры".
/// </summary>
public class SettingMenu : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            options.Add($"{resolutions[i].width} x {resolutions[i].height} @ {resolutions[i].refreshRate} Hz"); //Специально используется устаревший метод.
