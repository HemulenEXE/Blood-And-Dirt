...
public class UnvisibleClickedObject : MonoBehaviour, IInteractiveObject
{
    ...
    /// Главная камера.
    /// </summary>
    public static Camera _mainCamera = Camera.main;
    /// <summary>
    ...
    protected CircleCollider2D Collider
    {
        ...
        set
        {
            if (value == null) throw new ArgumentNullException("ClickedObject: Collider is null");
            _collider = value;
        }
    }
    ...
    /// </summary>
    private string _fontName = "PixelFont";
    /// <summary>
