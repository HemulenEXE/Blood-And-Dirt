...
/// <summary>
/// Класс, реализующий "интерактивные объекты, над которыми высвечивается текст и которые нельзя взять в инвентарь".
/// </summary>
public class VisibleClickedObject : UnvisibleClickedObject
{
    ...
    protected Renderer Renderer
    {
        ...
        set
        {
            if (value.Equals(null)) throw new ArgumentNullException("VisibleClickedObject: Collider is null");
            _renderer = value;
        }
    }
    /// <summary>
    ...
    public string FontName
    {
        ...
        set
        {
            if (value.Equals(null)) throw new ArgumentNullException("VisibleClickedObject: FontName is null");
            if (value.Length.Equals(0)) throw new ArgumentOutOfRangeException("VisibleClickedObject: Length of FontName is 0");
            _fontName = value;
        }
    }
    /// <summary>
    ...
    public float FontSize
    {
        ...
        set
        {
            if (value <= 0) throw new ArgumentOutOfRangeException("VisibleClickedObject: FontSize <= 0");
            _fontSize = value;
        }
    }
    /// <summary>
